      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
            ...
            <button
              onClick={logout}
              className="px-6 py-2 bg-red-600 text-white font-bold rounded-lg shadow-md hover:bg-red-700 transition-colors duration-200"
            >
              Logout
            </button>
          </div>
        ...
        <button
          onClick={() => openModal()}
          className="mb-8 px-6 py-2 bg-orange-600 text-white font-bold rounded-lg shadow-md hover:bg-orange-700 transition-colors duration-200"
        >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      <button
                        ...
                        className="px-4 py-1 bg-red-500 text-white text-sm font-semibold rounded hover:bg-red-600 transition-colors duration-200"
                      >
                        Delete
                      </button>
                    </div>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      id="formTitle"
                      className="w-full rounded border border-gray-300 px-3 py-2 focus:border-orange-500 focus:ring-orange-500"
                      value={formTitle}
